# TitleChain Foundation organization profile

This special `.github` repository powers the public [TitleChain Foundation organization homepage](https://github.com/TitleChain-Foundation) and may provide organization-wide community health files and templates.
...
Higher organizational partnership pricing is not published as self-service pricing. Interested organizations should connect with `hello@titlechainfoundation.org` so scope, recognition, independence and public impact reporting can be agreed before acceptance.

Publication here does not by itself make a proposal a Foundation standard or create an M5 account, credential, organization role or legal authority.
